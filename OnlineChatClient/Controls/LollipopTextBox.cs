...
public class LollipopTextBox : Control
{
  ...
  readonly Color EnabledUnFocusedColor = Color.FromArgb(153,153,153);//ColorTranslator.FromHtml("#dbdbdb");
  readonly Color DisabledUnFocusedColor = Color.FromArgb(153,153,153);
  readonly Color DisabledStringColor = ColorTranslator.FromHtml("#babbbd");
