...
public class LollipopFileInput : Control
{
    ...
    public Button InPutBTN = new Button();
    ...
    Color EnabledUnFocusedColor = ColorTranslator.FromHtml("#999999");

    Color DisabledInputColor = ColorTranslator.FromHtml("#1F1F1F");
    Color DisabledUnFocusedColor = ColorTranslator.FromHtml("#1F1F1F");
    ...
    public void AddButton()
    {
        ...
        InPutBTN.ForeColor = ColorTranslator.FromHtml("#1F1F1F");
    ...
    public void AddTextBox()
    {
        ...
        LollipopTB.BackColor = ColorTranslator.FromHtml("#1F1F1F");
        LollipopTB.UseSystemPasswordChar = UseSystemPasswordChar;       
